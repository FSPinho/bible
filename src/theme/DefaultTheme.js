...
export default {
    palette: {
        ...
        primaryText: Palette.Blue500Text,
        primaryTextPrimary: Palette.Blue500TextPrimary,
        primaryTextSecondary: Palette.Blue500TextSecondary,
        primaryTextDisabled: Palette.Blue500TextDisabled,

        accent: Palette.LightBlue,
        accentText: Palette.LightBlue500Text,
        accentTextPrimary: Palette.LightBlue500TextPrimary,
        accentTextSecondary: Palette.LightBlue500TextSecondary,
        accentTextDisabled: Palette.LightBlue500TextDisabled,
